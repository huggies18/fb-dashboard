...
import sys
sys.path.insert(0, '/root/.openclaw/workspace/c1/scraper')
...
# Config
SCRAPER_LOG = '/root/.openclaw/workspace/c1/scraper/scrape_all.log'
ALL_POSTS_FILE = '/root/.openclaw/workspace/c1/scraper/all_posts.json'
RESULT_FILE = '/root/.openclaw/workspace/c1/scraper/filter_result.json'
...
async def step1_scrape():
    ...
    os.system('cd /root/.openclaw/workspace/c1/scraper && nohup python3 scrape_all_posts.py > /dev/null 2>&1 &')
